...
export const PRESETS: Record<string, VisualPreset> = {
  ...
  "signal-field-minimal": {
    name: "Signal Field Minimal",
    palette: ["#F5FAFF", "#DDD8CD", "#98A08F", "#A5A298", "#4F574E", "#A68A63"],
    membraneAmount: 0.5,
    topographyAmount: 0.3,
    particleAmount: 0.1,
    gridAmount: 0.4,
    glow: 0.4,
    blur: 0.3,
